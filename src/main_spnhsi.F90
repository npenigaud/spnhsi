...
#endif
#ifdef USE_OPENMP
!$OMP TARGET DATA MAP (TOFROM:PSPVORG, PSPDIVG, PSPTG, PSPSPG, PSPSPDG, PSPSVDG, PSPTNDSI_VORG, PSPTNDSI_DIVG, &
!$OMP          & PSPTNDSI_TG, PSPTNDSI_SPDG, PSPTNDSI_SVDG, PSPAUXG) IF (TRIM (CLMETHOD) == 'openaccsingleblock' )
#endif
...
WRITE(0,*) "ZTC computation : ",ZTC
WRITE(0,*) "ZTD data : ",ZTD
